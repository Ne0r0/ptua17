# Create 3 separate list . One list contains shopt items, another list - prices, and last list amount.
# Ask user to enter the number of item baskets she/he wants to create (min 5 max 10 buckets).
